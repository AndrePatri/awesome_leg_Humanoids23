...
\begin{figure}[t]
    ...
    \caption{Snapshots of our quadruped leg prototype performing an optimal jump maneuver obtained with our TO formulation, in simulation (top) and on the real hardware (bottom), from left to right.\vspace{-0.5cm}}
