...
Motivated by the end goal of developing a new heavy-duty and electrically powered agile quadruped, we present an in-depth case study revolving around our torque-controllable $12~\mathrm{kg}$ quadruped leg prototype (shown in Fig.~\ref{fig:jumping_sequence}). We choose to focus our attention on the most meaningful and complex task achievable with a single leg setup: the jump. 
